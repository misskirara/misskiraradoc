...
横：最大600px程度  
縦：最小40px程度  
リアクションで表示される場合に縦の解像度が最大でも35pxなので、基本的に40px前後だと過不足ないと思います。  
但し、ノート上で拡大して使用する場合などもありますので、その可能性が高そうな絵文字は縦も大きめに作成するのが無難です。    
縦横比については概ねスマートフォン版では1:10,PC版では1:20を超えると、リアクションが画面からはみ出ますのでご注意ください。  
